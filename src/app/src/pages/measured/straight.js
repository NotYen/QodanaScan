...
/* import `Image` source */
import scope from '../../assecs/images/icon/scope_straight.png';
import audio from '../../assecs/images/icon/audio.png';
import videoBG from '../../assecs/images/gif/straight.gif';
...
const StraightMeasured = () => {
    ...
    return (
        <Stack className="position-fixed" layerStyle={ 'imitate' }>
            <Box className="camera-container">
                <Text className="title">畫直線</Text>
...
export default StraightMeasured;
