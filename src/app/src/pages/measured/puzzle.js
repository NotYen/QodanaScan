...
import scope from '../../assecs/images/icon/scope_puzzle-house.png';
import audio from '../../assecs/images/icon/audio.png';
import videoBG from '../../assecs/images/gif/puzzle-house.gif';
    ...
    return (
        <Stack className="position-fixed" layerStyle={ 'building' }>
            ...
            <Stack className="control-container">
                <p className="prompt-text flex-center prompt-puzzle">
                    <div className='palm-text-1'>
                        <samp className="icon">
                            <LazyLoadImage src={ palm } />
                        </samp>
                        <samp>示範將兩片圖卡拼起來，然後恢復原狀後，</samp>
                    </div>
                    <samp className='palm-text-2'>擺成一片橫向，一片直向後說｢換你」</samp>
                </p>
