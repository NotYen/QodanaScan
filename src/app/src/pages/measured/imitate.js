...
/* import `Image` source */
import scope from '../../assecs/images/icon/scope.png';
import audio from '../../assecs/images/icon/audio.png';
import videoBG from '../../assecs/images/gif/imitate.gif';
    ...
    return (
        <Stack className="position-fixed" layerStyle={'imitate'}>
            <Box className="camera-container">
                <Text className="title">動作模仿</Text>
...
export default ImitateMeasured;
