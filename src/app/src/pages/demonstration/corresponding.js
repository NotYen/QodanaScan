...
/* import `Image` source */
import dinosaur01 from '../../assecs/images/source/source_32.png';
import dinosaur02 from '../../assecs/images/source/source_33.png';
...
const CorrespondingMeasured = () => {
    ...
    useEffect(() => {
        if (complete.length === 1) {
            setCompleted(true);
            setTimeout(() => navigate('/games/corresponding/measured') , 1000);
        }
    ...
    return (
        <Box layerStyle={ 'corresponding' }>
            <Subject title='恐龍對應圖卡練習' illustrate={ instruction.illustrate } />
            <Box className="measured-container">
                ...
                <Button className="button-next" onClick={ handleClick }>完成</Button>
